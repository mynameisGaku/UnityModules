...
次の候補は、Project Settings、Build Profile、Qualityなど新規Projectで繰り返す設定をPreview後にまとめて適用する「プロジェクト初期設定アシスタント」とする。Build Guardの検査・修復やModule Installerのpackage導入とは責務を分ける。
