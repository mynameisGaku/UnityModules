...
namespace ModuleInstaller.Editor
{
    internal static class ModuleCatalog
    {
        ...
        {
            Entry("com.studiogaku.project-setup", "ProjectSetup", "project-setup-v1.4.0", "Project Setup", "Previews, backs up, applies, and restores Project Settings, scripting define symbols, Tags, Layers, Build Scenes, and the Play Mode Start Scene."),
