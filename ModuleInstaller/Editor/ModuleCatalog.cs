...
namespace ModuleInstaller.Editor
{
    internal static class ModuleCatalog
    {
        ...
        {
            Entry("com.studiogaku.project-setup", "ProjectSetup", "project-setup-v1.7.0", "Project Setup", "Creates recommended project folders and previews, backs up, applies, and restores Project Settings, code generation defaults, duplicate naming defaults, scripting define symbols, Tags, Layers, Build Scenes, and the Play Mode Start Scene."),
