    ...
    internal static class ModuleCatalog
    {
        ...
        private static readonly ModuleBundle[] CatalogBundles =
        {
            ...
            Bundle("scene-and-ui", "Scene and UI", "Prepare reusable Editor scene workspaces, then build a predictable runtime scene, screen, pause, and startup flow.", ModuleBundleTier.Recommended,
                "Use this when switching between multi-scene editing setups or implementing scene changes, fades, safe areas, pause behavior, or startup order together.",
                ...
                "com.studiogaku.scene-workspace", "com.studiogaku.scene-flow", "com.studiogaku.screen-transition", "com.studiogaku.adaptive-layout", "com.studiogaku.time-control", "com.studiogaku.startup-flow"),
