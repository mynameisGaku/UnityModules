...
namespace ModuleInstaller.Editor
{
    internal static class ModuleCatalog
    {
        ...
        {
            Entry("com.studiogaku.project-setup", "ProjectSetup", "project-setup-v1.1.0", "Project Setup", "Previews, backs up, applies, and restores Project Settings, Tags, Layers, and Sorting Layers."),
