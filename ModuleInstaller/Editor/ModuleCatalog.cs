...
namespace ModuleInstaller.Editor
{
    internal static class ModuleCatalog
    {
        ...
        {
            Entry("com.studiogaku.project-setup", "ProjectSetup", "project-setup-v1.14.0", "Project Setup", "Creates recommended project folders, Runtime and Editor assembly definitions, optional test assembly definitions, and Unity-ready version control files, then previews, backs up, applies, and restores Project Settings, build-target application identifiers, scripting backends, API compatibility levels, managed stripping levels, code generation defaults, duplicate naming defaults, scripting define symbols, Tags, Layers, Build Scenes, and the Play Mode Start Scene."),
