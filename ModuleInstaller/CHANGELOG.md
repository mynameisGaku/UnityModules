...
- テクスチャー取込設定監査の固定版を1.2.0へ更新し、日本語画面、反映途中の例外記録、再取込完了件数の報告、直前の操作と分けた取り消し単位を導入対象へ反映しました。
- 一覧説明の対象機種名と最初の操作を、1.2.0の「パソコン」表示と日本語メニューへ同期しました。
- 固定タグ、個別説明への導線、用途別セットの版表示を試験と文書で同期しました。

## [1.6.1] - 2026-09-01

- ビルド実行アシスタントの固定版を1.1.0へ更新し、日本語画面、ビルド直前の入力・出力再検査、安全上限付きの履歴と復旧を導入対象へ反映しました。
- 固定タグ、個別説明と初回操作への導線、用途別セットの版表示を試験と文書で同期しました。
- 画面説明と手引きに残っていた置換可能な英語を日本語へ改め、一覧説明への再混入を検出する試験を追加しました。
